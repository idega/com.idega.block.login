/**
 * @(#)PasswordTokenBean.java    1.0.0 10:40:29 AM
 *
...
/**
 * <p>JSF managed bean for {@link PasswordTokenCreator} component.</p>
...
public class PasswordTokenBean {
	...
	public static final String CAPCHA_FAILED = "capcha_failed";
	...
	public String getCapcha() {
		if(!StringUtil.isEmpty(this.capcha)) {
			return this.capcha.toUpperCase();
		} else {
			return null;
		}
	}
	...
	public List<String> getEmails() {
		return getPasswordTokenBusiness().getEmailAddresses(getIdentifier());
	}
	...
	public boolean isCapchaFailed () {
		String failed = CoreUtil.getIWContext().getParameter(CAPCHA_FAILED);
		if (Boolean.TRUE.toString().equals(failed)) {
			return Boolean.TRUE;
		}
	...
	public boolean isProcessStarted() {
		String processStarted = CoreUtil.getIWContext().getParameter(PROCESS_STARTED);
		if (Boolean.TRUE.toString().equals(processStarted)) {
			return Boolean.TRUE;
		}
	...
	protected String getIpAddress() {
		return getIWContext().getRemoteIpAddress();
	}
