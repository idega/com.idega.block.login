/**
 * @(#)LoginAttemptsAmountEntity.java    1.0.0 3:02:35 PM
 *
...
/**
 * <p>Saves number of login attempts from IP address</p>
 ...
 */
@Entity
@Table(name = LoginAttemptsAmountEntity.TABLE_NAME)
@NamedQueries({
	@NamedQuery(
			name = LoginAttemptsAmountEntity.QUERY_FIND_ALL, 
...
public class LoginAttemptsAmountEntity {
	...
	public static final String TABLE_NAME = "ic_login_attempts_amount";
