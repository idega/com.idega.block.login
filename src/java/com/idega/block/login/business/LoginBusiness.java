	...
	*/
	...
	private int verifyPasswordAndLogin(IWContext iwc, String login, String password) throws Exception {
		...
		LoginTable[] login_table =
			(LoginTable[]) (com.idega.core.accesscontrol.data.LoginTableBMPBean.getStaticInstance()).findAllByColumn(com.idega.core.accesscontrol.data.LoginTableBMPBean.getUserLoginColumnName(), login);
		if (login_table == null)
