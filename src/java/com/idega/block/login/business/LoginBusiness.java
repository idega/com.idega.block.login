...
*/
  ...
  private boolean logIn(IWContext iwc, LoginTable loginTable, String login) throws Exception{
    ...
    if(userGroupId != -1){
      ...
      LoginBusiness.setUserRepresentativeGroup(iwc,((com.idega.core.user.data.UserGroupRepresentativeHome)com.idega.data.IDOLookup.getHomeLegacy(UserGroupRepresentative.class)).findByPrimaryKeyLegacy(userGroupId));
